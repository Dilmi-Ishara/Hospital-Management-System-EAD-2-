...
export default function AppointmentForm() {
  ...
  useEffect(() => {
    ...
    if (doctor) {
      ...
      axios
        .get(`${API_ROOM}/doctor/${selectedDoctorId}`)
        .then((res) => {
    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label>
          ...
          <button type="button" onClick={fetchPatientByContact}>Find Patient</button>
        </label>
        ...
        <div className="button-row">
          ...
          <button type="button" onClick={() => navigate("/appointments")}>Cancel</button>
        </div>
      </form>
