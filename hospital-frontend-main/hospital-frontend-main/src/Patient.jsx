...
>
  ...
  Dashboard
        ...
        <button style={addButtonStyle} onClick={() => navigate("/add-patient")}>
          + Add Patient
        </button>
      </div>
      ...
      <div style={filterContainerStyle}>
        ...
        <button onClick={fetchPatients} style={resetButtonStyle}>
          Clear
        </button>
      </div>
            ...
            <tr key={pat.id}>
              ...
              {editingId === pat.id ? (
                ...
                <>
                  ...
                  <td style={tdStyle}>{pat.gender}</td>
                  <td style={tdStyle}>{pat.contactNumber}</td>
