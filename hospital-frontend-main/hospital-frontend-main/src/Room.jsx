// Updated RoomsPage.js with matching CSS styling from DoctorsPage
  ...
  return (
    <div style={containerStyle}>
      <div style={headerBarStyle}>
        ...
        <button style={addButtonStyle} onClick={() => navigate("/add-room")}>+ Add Room</button>
      </div>
      ...
      <div style={filterContainerStyle}>
        <input
          ...
          style={inputStyle}
        />
        <button onClick={handleSearchByRoomType} style={buttonStyle}>Search</button>
        <button onClick={fetchRooms} style={resetButtonStyle}>Reset</button>
      </div>
      ...
      <table style={tableStyle}>
        ...
        <tbody>
            ...
            <tr key={room.id}>
              ...
              {editingId === room.id ? (
                  <>
                    ...
                    <td>{room.floor}</td>
                  <td style={tdStyle}>
                    <select name="doctorId" value={editForm.doctorId} onChange={handleEditInputChange} style={inlineInputStyle}>
                      <option value="">Unassigned</option>
                      {doctors.map(doc => <option key={doc.id} value={doc.id}>{doc.name}</option>)}
                    </select>
                  </td>
                  <td style={tdStyle}>
                    <select name="status" value={editForm.status} onChange={handleEditInputChange} style={inlineInputStyle}>
          ...
          {rooms.length === 0 && (
            <tr>
              <td colSpan="7" style={{ textAlign: "center", padding: "20px", color: "#888" }}>No rooms found</td>
            </tr>
          )}
        </tbody>
      </table>
